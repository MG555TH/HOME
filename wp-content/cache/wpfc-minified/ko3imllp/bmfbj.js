// source --> https://www.ufayou.co/wp-content/themes/wp/js/jquery.min.js?ver=5.8.4 
...
// source --> https://www.ufayou.co/wp-content/themes/wp/js/popper.min.js?ver=5.8.4 
/*
...
// source --> https://www.ufayou.co/wp-content/themes/wp/js/bootstrap.min.js?ver=5.8.4 
/*!
...
// source --> https://www.ufayou.co/wp-content/themes/wp/js/jackpot.js?ver=5.8.4 
var v = new Array();
var vDisp = new Array();
var jpCount = 0;
var jackpotTimer;
...
function getJackpotValues(myValues, jpCountValue) {
    ...
    var d = new Date();
    var year =
        d.getFullYear().toString().length == 1 ?
        '0' + d.getFullYear().toString() :
    ...
    for (i = 0; i < jpCount; i++) {
        if (isNaN(myValues.split(';')[i])) {
            ...
            v[i] = parseInt(myValues.split(';')[i]) + parseInt(dateOffset - 10);
            vDisp[i] = v[i];
        }
    }
...
function displayJackpotValues(myID, myVal) {
    ...
    if (isNaN(myVal)) {
        ...
        document.getElementById(myID).innerHTML = parseFloat(myVal).formatMoney(
            2,
            ',',
            '.'
        );
...
// source --> https://www.ufayou.co/wp-content/themes/wp/js/jquery.number.min.js?ver=5.8.4 
